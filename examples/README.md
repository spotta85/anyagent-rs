...
| Example | Shows | Run |
|---|---|---|
| [`chat.rs`](chat.rs) | The core loop: open a session, prompt, stream events, answer permission requests. Typing mid-turn steers the running turn. | `cargo run --example chat -- claude` |
